...
import PerformSelected from '../../../images/loginpage/PerformSelected.jsx';
import PhotoCam from "../../../images/loginpage/PhotoCam.svg"
import './bestPerfMentor.css';

const BestPerfMentors = () => {
    ...
    useEffect(() => {
        const fetchMentorStats = async (selectedMentor) => {
            try {
                const applicationsResponse = await fetch(`${import.meta.env.VITE_API_URL}/api/company/mentorApplications/${selectedMentor._id}/done`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`,
    ...
    return (
        <div className="best-performing-mentors">
            <h2>Best Performing Mentors</h2>
            <div className="best-mentors-perform">
...
export default BestPerfMentors